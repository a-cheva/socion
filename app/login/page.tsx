    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <Card className="w-full max-w-md shadow-sm">
        <CardHeader className="text-center pb-2">
          <div className="text-3xl font-bold text-[#ff385c] mb-2">SocioN</div>
          <CardTitle className="text-xl font-semibold text-gray-900">
            Entrar na plataforma
          </CardTitle>
          <CardDescription className="text-gray-500 text-sm mt-1">
            Conecte-se com LinkedIn para importar seu perfil profissional automaticamente.
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="flex flex-col gap-3 pt-4">
          ...
          >
            <Button
              type="submit"
              className="w-full bg-[#0077b5] hover:bg-[#006399] text-white h-12 text-base font-medium"
            >
          ...
          >
            <Button type="submit" variant="outline" className="w-full h-12 text-base font-medium border-gray-300">
